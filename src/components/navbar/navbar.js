...
const Navbar = ({ userDetails }) => {
  ...
  const menu = (
    <Menu style={{ backgroundColor: '#212936' }}>
      <Menu.Item key="username" style={{ color: 'white', pointerEvents: 'none' }}>
      ...
      <Menu.Item key="logout" style={{ backgroundColor: '#212936', color: 'white' }}>
      ...
      <Header style={{ padding: '0', height: '67px' }}>
        <Row>
          ...
          <Col xxl={17} xl={17} lg={17} xs={20} md={20} sm={20}>
            ...
            >
              <Menu.Item key="create-new-cluster" style={{ backgroundColor: '#09132b' }}>
                <Button
                  type="text"
                  style={{
                    color: 'black',
              ...
              {userDetails && (
                <Menu.Item key="user-avatar" style={{ backgroundColor: '#09132b' }}>
