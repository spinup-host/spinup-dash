...
const BackupInfo = () =>{
    ...
    <Navbar/>
        ...
        <Row>
            <Col xxl={4} xl={4} lg={4} xs={20} md={10} sm={20} style={{marginLeft:"233px",marginTop:"20px"}}>
          ...
          <Col xxl={4} xl={4} lg={4} xs={20} md={10} sm={20} style={{marginLeft:"100px",marginTop:"20px"}}>
          ...
          <Row><Col xxl={4} xl={4} lg={4} xs={20} md={10} sm={20} style={{marginLeft:"233px",marginTop:"20px"}}>
